...
var (
	...
	以太充能1 = 刻印{名字: "以太充能1", 增强集: []增强体{
		{类型: 攻增, 率: default率, 系: 0.06},
	}}
	以太充能3 = 刻印{名字: "以太充能3", 增强集: []增强体{
		{类型: 攻增, 率: default率, 系: 0.15},
	}}
	肾上腺素1 = 刻印{名字: "肾上腺素1", 增强集: []增强体{
		{类型: 攻增, 率: default率, 系: 0.018},
		{类型: 暴增, 率: 0.05, 系: default系},
	}}
...
func main() {
	...
	*/
	...
	// fmt.Println("---镰刀开z  20暴击、650会心 23暴击，约43暴击；加2暴击拐约63暴击")
	// DamagePrintWithOptions(0.2, 肾上腺素3,迅捷利刃3,强力侧击3)
	// DamagePrintWithOptions(0.2, 肾上腺素3,迅捷利刃3,尖刺重锤3)
	// DamagePrintWithOptions(0.2, 怨恨3,肾上腺素3,迅捷利刃3)
	// DamagePrintWithOptions(0.2, 怨恨3,肾上腺素3,迅捷利刃3,尖刺重锤2)
	// DamagePrintWithOptions(0.2, 怨恨3,肾上腺素3,迅捷利刃3,以太充能1)
	// DamagePrintWithOptions(0.2)
	// DamagePrintWithOptions(0.2, 尖刺重锤3)
	// DamagePrintWithOptions(0.2, 尖刺重锤2)
	// DamagePrintWithOptions(0.2, 以太充能1)
	DamagePrintWithOptions(0.2, 肾上腺素3, 尖刺重锤2)
	DamagePrintWithOptions(0.2, 肾上腺素3, 以太充能1)
	// DamagePrintWithOptions(0.2, 肾上腺素3, 尖刺重锤2,头背套3)
	// DamagePrintWithOptions(0.2, 肾上腺素3)
	// DamagePrintWithOptions(0.2, 肾上腺素1, 尖刺重锤2, 头背套3)
	// DamagePrintWithOptions(0.2, 肾上腺素1, 重量强化3, 头背套3)
}
